...
def readCommand( argv ):
    ...
    parser.add_option('-n', '--episodes', dest='episodes', type='int',
                      help=default('the number of training episodes to play'), metavar='episodes', default=1)
    parser.add_option('-e', '--training_mode', action='store_true', dest='training_mode',
                      help='Training and no graphics', default=False)

    parser.add_option('-l', '--layout', dest='layout',
                      help=default('the LAYOUT_FILE from which to load the map layout'),
                      metavar='LAYOUT_FILE', default='labAA1')
    ...
    agentOpts['numTraining'] = args['episodes']
    args['training_mode'] = options.training_mode

    if options.training_mode:
        agentOpts['epsilon'] = 0.8
        agentOpts['alpha'] = 0.3
        agentOpts['gamma'] = 0.9
    else:
        agentOpts['epsilon'] = 0.2
        agentOpts['alpha'] = 0
...
def runGames( layout, pacman, ghosts, display, episodes, training_mode, maxMoves=-1):
